...
| RLCD Primitives: *"put the red cube on the green cube"* (stacking) | **4/5** stacked from four spawn points, **1–2 mm** from the destination centre, stack height 0.037 m; the failure was a descent the arm could not make at the edge of the workspace |
