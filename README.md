...
| Agent: three-cube stack (blue on green, red on blue) | **4/5** succeeded, ≈ 48–52 s; final heights 0.012 / 0.037 / 0.062 m (one run built the stack in the wrong order) |
...
| RLCD Primitives: *"put the red cube on the green cube"* (stacking) | **4/5** stacked from four spawn points, **1–2 mm** from the destination centre, stack height 0.037 m; the fifth spawn sat at the edge of the arm's reach |
