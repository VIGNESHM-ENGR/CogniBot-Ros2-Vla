import { FRONT_CAMERA_SIZE, TOPICS } from "../config";
import type { GoalRun } from "../ros/hooks";
import type { AgentEventMsg, ObjectDetectionMsg, RunAgentTaskFeedback } from "../ros/messages";
...
interface Props {
  ...
  detection: ObjectDetectionMsg | null;
}
...
/** Language agent: a task in, the model's tool calls streamed out, detections on the camera. */
export function AgentView(props: Props) {
  const { agentOnline, run, events, detection } = props;
