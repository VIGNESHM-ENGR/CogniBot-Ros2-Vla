...
| `smolvla_arena_multitask` | [`Chaenn/smolvla_policy_so101_cube_multitask_sim_0824`](https://huggingface.co/Chaenn/smolvla_policy_so101_cube_multitask_sim_0824) @ `111cf91950868312aa64d89f83595e5da981f6ed` | SmolVLA (60k steps on `lerobot/smolvla_base`) | `capstone_arena` simulator, SO-101, 295 episodes / 629k frames; **state and action in degrees** (same joint signs and ranges as our MuJoCo model); task text "Pick and place each of the five cubes inside the black boundary." | `side`, `wrist` 640×480 (preprocessor renames them to `camera1`, `camera2`) | Apache-2.0 |
